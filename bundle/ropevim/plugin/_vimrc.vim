...
" ==============================================================================
"au MenuPopup * call ToggleFTContextMenu("python","nmenu","PopUp.-Usrsep4-",":")
"au MenuPopup * call ToggleFTContextMenu("python","imenu","PopUp.-Usrsep4-",":")
...
"" (plugin-ropevim)
au MenuPopup * call ToggleFTContextMenu(["python"],["i","n"],"PopUp.Show\\ Documentation<tab><S-k>","RopeShowDoc()")

"" Поиск места определения объекта под курсором (plugin-ropevim)
au MenuPopup * call ToggleFTContextMenu(["python"],["i","n"],"PopUp.Goto\\ Definition<tab>gd","RopeGotoDefinition()")

"" Поиск всех мест где используется объект, находящийся под
"" курсором (plugin-ropevim)
au MenuPopup * call ToggleFTContextMenu(["python"],["i","n"], "PopUp.Find\\ Occurrences","RopeFindOccurrences()")
